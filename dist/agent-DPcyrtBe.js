...
import { H as normalizeThinkLevel, I as formatThinkingLevels, K as supportsXHighThinking, L as formatXHighModelHint, W as normalizeVerboseLevel } from "./pi-embedded-helpers-yEQRtLyw.js";
import { $t as getSkillsSnapshotVersion, Bt as getRemoteSkillEligibility, Cr as applyVerboseOverride, Gr as resolveAgentTimeoutMs, In as registerAgentRunContext, L as runWithModelFallback, M as resolveOutboundTarget, Mn as clearAgentRunContext, N as resolveSessionDeliveryTarget, Nn as emitAgentEvent, Or as loadModelCatalog, Sr as applyModelOverrideToSessionEntry, br as lookupContextTokens, i as runCliAgent, jn as AGENT_LANE_NESTED, l as runEmbeddedPiAgent, n as getCliSessionId, r as setCliSessionId, s as resolveSendPolicy, xr as clearSessionAuthProfileOverride } from "./reply-P_lTBhho.js";
import { d as resolveAgentIdFromSessionKey, l as normalizeAgentId, u as normalizeMainKey } from "./session-key-BWxPj0z_.js";
import { a as resolveAgentModelPrimary, i as resolveAgentModelFallbacksOverride, o as resolveAgentSkillsFilter, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, x as ensureAgentWorkspace } from "./agent-scope-bNHJh30H.js";
import { Dt as DEFAULT_MODEL, Et as DEFAULT_CONTEXT_TOKENS, Ot as DEFAULT_PROVIDER, a as isCliProvider, d as resolveConfiguredModelRef, h as resolveThinkingDefault, ht as ensureAuthProfileStore, o as modelKey, t as buildAllowedModelSet } from "./model-selection-0Mb0IXS7.js";
...
import { A as resolveSessionResetPolicy, D as resolveSessionKey, I as resolveExplicitAgentSessionKey, O as evaluateSessionFreshness, T as normalizeAccountId, d as loadSessionStore, g as updateSessionStore, j as resolveSessionResetType, k as resolveChannelResetConfig } from "./sandbox-BoauKXAW.js";
import { r as buildWorkspaceSkillSnapshot } from "./skills-Bau1zXIA.js";
...
import { a as normalizeOutboundPayloadsForJson, i as normalizeOutboundPayloads, r as formatOutboundPayloadLog, t as deliverOutboundPayloads } from "./deliver-5rp6-FOH.js";
...
async function updateSessionStoreAfterAgentRun(params) {
	...
	if (hasNonzeroUsage(usage)) {
		...
		next.totalTokens = deriveSessionTotalTokens({
			usage,
			contextTokens
		}) ?? input;
	}

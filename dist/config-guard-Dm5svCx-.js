...
import { S as shortenHomePath, _ as resolveHomeDir, x as shortenHomeInString, y as resolveUserPath } from "./utils-Dk86IbEs.js";
import { t as runCommandWithTimeout } from "./exec-B8JKbXKW.js";
import { c as resolveDefaultAgentId, f as DEFAULT_AGENT_WORKSPACE_DIR, h as DEFAULT_IDENTITY_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, w as resolveDefaultAgentWorkspaceDir, x as ensureAgentWorkspace } from "./agent-scope-D3me2AZa.js";
import { c as writeConfigFile, g as parseDurationMs, i as loadConfig, o as readConfigFileSnapshot, r as createConfigIO } from "./config-B492mw06.js";
import { n as movePathToTrash } from "./server-context-fX4xiYRh.js";
import { i as randomIdempotencyKey, n as callGateway } from "./call-DLO1BEhA.js";
...
import { $n as CHANNEL_TARGET_DESCRIPTION, D as runMemoryStatus, Dn as formatTargetDisplay, E as registerMemoryCli, Qn as CHANNEL_TARGETS_DESCRIPTION, _ as randomToken, a as applyWizardMetadata, c as ensureWorkspaceAndSessions, d as handleReset, f as moveToTrash, gn as lookupContextTokens, hn as resolveCommitHash, i as DEFAULT_WORKSPACE, kn as CHANNEL_MESSAGE_ACTION_NAMES, l as formatControlUiSshHint, m as openUrl, s as detectBrowserOpenSupport, v as resolveControlUiLinks, x as waitForGatewayReachable, yn as runMessageAction } from "./loader-DJRotWxM.js";
...
import { n as setupChannels } from "./onboard-channels-BJpLgPa5.js";
import { a as resolveSessionTranscriptsDirForAgent, i as resolveSessionTranscriptsDir, o as resolveStorePath } from "./paths-IivnSNkP.js";
import { d as loadSessionStore } from "./sandbox-BLyWpgSU.js";
import { n as formatTimeAgo } from "./format-relative-79_Y1n2Y.js";
import { n as runCommandWithRuntime } from "./cli-utils-PlLcDZlM.js";
import { n as ensurePluginRegistryLoaded, t as hasExplicitOptions } from "./command-options-1Oati29A.js";
import { l as getVerboseFlag, o as getFlagValue, r as registerSubCliCommands, s as getPositiveIntFlagValue, u as hasFlag } from "./register.subclis-aBjcOGqz.js";
import { n as parsePositiveIntOrUndefined, t as collectOption } from "./helpers-CQI-5xS9.js";
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-ANWuGRVb.js";
import { t as createDefaultDeps } from "./deps-CJdvY4AA.js";
import { a as gatewayInstallErrorHint, h as assertSupportedRuntime, i as buildGatewayInstallPlan, r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-BcoVPWAL.js";
...
import { t as renderTable } from "./table-cCoGqLsk.js";
import { _ as applyOpenAIConfig, a as applyCustomApiConfig, b as promptAuthChoiceGrouped, c as resolveCustomProviderId, g as applyAuthChoice, h as warnIfModelConfigLooksOff, i as CustomApiError, o as parseNonInteractiveCustomApiFlags, v as upsertSharedEnvVar, y as applyGoogleGeminiModelDefault } from "./onboard-skills-B81nfPnJ.js";
import { l as healthCommand } from "./health-format-Cr5lMMdM.js";
import { $ as setCloudflareAiGatewayConfig, C as applyLitellmConfig, E as applyMoonshotConfigCn, F as applyTogetherConfig, G as applyZaiConfig, L as applyVeniceConfig, N as applySyntheticConfig, Q as setAnthropicApiKey, T as applyMoonshotConfig, U as applyXiaomiConfig, V as applyXaiConfig, at as setOpencodeZenApiKey, bt as buildTokenProfileId, ct as setSyntheticApiKey, dt as setVercelAiGatewayApiKey, et as setGeminiApiKey, f as applyOpencodeZenConfig, ft as setXaiApiKey, g as applyMinimaxConfig, it as setMoonshotApiKey, j as applyQianfanConfig, k as applyOpenrouterConfig, lt as setTogetherApiKey, m as applyMinimaxApiConfig, mt as setZaiApiKey, nt as setLitellmApiKey, ot as setOpenrouterApiKey, pt as setXiaomiApiKey, rt as setMinimaxApiKey, st as setQianfanApiKey, tt as setKimiCodingApiKey, ut as setVeniceApiKey, v as applyAuthProfileConfig, x as applyKimiCodeConfig, xt as validateAnthropicSetupToken, y as applyCloudflareAiGatewayConfig, z as applyVercelAiGatewayConfig } from "./github-copilot-auth-Cu08j7QM.js";
import { n as logConfigUpdated, t as formatConfigPath } from "./logging-DuK6YXuK.js";
import { a as findAgentEntryIndex, c as pruneAgentConfig, d as parseIdentityMarkdown, f as runOnboardingWizard, i as buildAgentSummaries, l as identityHasValues, o as listAgentEntries, r as applyAgentConfig, s as loadAgentIdentity, t as statusCommand } from "./status-BgryRZ0n.js";
import { a as createOutboundSendDeps, n as resolveSessionKeyForRequest, t as agentCommand } from "./agent-BbREE1w4.js";
import { t as formatHelpExamples } from "./help-format-CUnac_bT.js";
import { i as CONFIGURE_WIZARD_SECTIONS, n as configureCommand, r as configureCommandWithSections } from "./configure-BavDCARX.js";
import { n as ensureSystemdUserLingerNonInteractive } from "./systemd-linger-CDo2UbHM.js";
import { n as loadAndMaybeMigrateDoctorConfig, t as doctorCommand } from "./doctor-C-KzBhfI.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-BavDCARX.js").then((n) => n.t);

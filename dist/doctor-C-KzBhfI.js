import { F as CONFIG_PATH, G as resolveIsNixMode, J as resolveOAuthDir, K as resolveLegacyStateDirs, M as getResolvedLoggerSettings, W as resolveGatewayPort, X as resolveStateDir, n as isTruthyEnvValue, p as defaultRuntime, pt as resolveRequiredHomeDir, q as resolveNewStateDir } from "./entry.js";
import { Dt as CLAUDE_CLI_PROFILE_ID, E as getModelRefStatus, F as resolveHooksGmailModel, N as resolveConfiguredModelRef, Ot as CODEX_CLI_PROFILE_ID, Tt as DEFAULT_PROVIDER, _ as ensureAuthProfileStore, f as repairOAuthProfileIdMismatch, o as resolveProfileUnusableUntilForDisplay, s as resolveApiKeyForProfile, wt as DEFAULT_MODEL, y as updateAuthProfileStoreWithLock } from "./auth-profiles-BZAsA3O9.js";
...
import { C as sleep, S as shortenHomePath, _ as resolveHomeDir$1, d as isRecord } from "./utils-Dk86IbEs.js";
...
import { c as resolveDefaultAgentId, d as DEFAULT_AGENTS_FILENAME, s as resolveAgentWorkspaceDir } from "./agent-scope-D3me2AZa.js";
import { c as writeConfigFile, n as migrateLegacyConfig, o as readConfigFileSnapshot, u as OpenClawSchema } from "./config-B492mw06.js";
import { c as resolveGatewayBindHost, r as isLoopbackHost } from "./ws-C0k_dhCP.js";
import { d as formatPortDiagnostics, l as inspectPortUsage } from "./chrome-yIKmOzCO.js";
import { i as resolveGatewayAuth } from "./auth-BcNHFK-i.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-DLO1BEhA.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-Dv9th7OE.js";
import { n as listChannelPlugins } from "./plugins-B7F0Ly9G.js";
import { Zt as loadModelCatalog, _ as randomToken, a as applyWizardMetadata, h as printWizardHeader, t as loadOpenClawPlugins, u as guardCancel } from "./loader-DJRotWxM.js";
...
import { a as resolveSessionTranscriptsDirForAgent, n as resolveSessionFilePath, o as resolveStorePath } from "./paths-IivnSNkP.js";
import { I as resolveMainSessionKey, N as canonicalizeMainSessionAlias, W as resolveSandboxScope, d as loadSessionStore, et as DEFAULT_SANDBOX_BROWSER_IMAGE, m as saveSessionStore, nt as DEFAULT_SANDBOX_IMAGE, tt as DEFAULT_SANDBOX_COMMON_IMAGE } from "./sandbox-BLyWpgSU.js";
import { n as isWSLEnv, t as isWSL } from "./wsl-jBJ2sR3G.js";
...
import { i as readChannelAllowFromStore } from "./pairing-store-CO6umWFP.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-DFhI_u0p.js";
import { a as gatewayInstallErrorHint, d as renderSystemNodeWarning, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, p as resolveSystemNodeInfo, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-BcoVPWAL.js";
import { a as repairLaunchAgentBootstrap, i as launchAgentPlistExists, n as isLaunchAgentListed, o as resolveGatewayLogPaths, r as isLaunchAgentLoaded, t as resolveGatewayService } from "./service-DDPRbf8a.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-BEWwfwn0.js";
import { n as renderSystemdUnavailableHints, t as isSystemdUnavailableDetail } from "./systemd-hints-zi4ohCOY.js";
import { a as renderGatewayServiceCleanupHints, i as findExtraGatewayServices, n as auditGatewayServiceConfig, o as readLastGatewayErrorLine, r as needsNodeRuntimeMigration, t as SERVICE_AUDIT_CODES } from "./service-audit-BGCzyg1J.js";
import { i as resolveControlUiDistIndexPathForRoot, l as healthCommand, r as resolveControlUiDistIndexHealth, t as formatHealthCheckFailure } from "./health-format-Cr5lMMdM.js";
import { f as doctorShellCompletion, t as runGatewayUpdate } from "./update-runner-3YIbaMs5.js";
import { n as logConfigUpdated } from "./logging-DuK6YXuK.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-CJMt5NLm.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-Bi7-jyzZ.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-CDo2UbHM.js";

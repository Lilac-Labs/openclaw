import { D as info, I as colorize, L as isRich, R as theme, c as defaultRuntime, t as createSubsystemLogger } from "./subsystem-Bh1Y_6Uv.js";
import { A as resolveHeartbeatDeliveryTarget, Dr as peekSystemEvents, Gn as resolveUserTimezone, Wn as resolveEffectiveMessagesConfig, _n as appendCronStyleCurrentTimeLine, _r as isHeartbeatContentEffectivelyEmpty, ct as setHeartbeatWakeHandler, dr as CommandLane, fn as resolveHeartbeatVisibility, gn as resolveIndicatorType, gr as DEFAULT_HEARTBEAT_EVERY, hr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, j as resolveHeartbeatSenderContext, lr as getQueueSize, pn as emitHeartbeatEvent, st as requestHeartbeatNow, t as getReplyFromConfig, vr as resolveHeartbeatPrompt$1, yr as stripHeartbeatToken } from "./reply-P_lTBhho.js";
...
import { n as resolveOpenClawPackageRootSync, t as resolveOpenClawPackageRoot } from "./openclaw-root-93W6UrUK.js";
import { c as resolveDefaultAgentId, m as DEFAULT_HEARTBEAT_FILENAME, n as resolveAgentConfig, s as resolveAgentWorkspaceDir } from "./agent-scope-bNHJh30H.js";
import { t as isTruthyEnvValue } from "./env-BxRc6wWv.js";
import { g as parseDurationMs, i as loadConfig } from "./config-CqX-XS_G.js";
import { f as resolvePreferredAccountId, n as listChannelPlugins, t as getChannelPlugin, u as buildChannelAccountBindings } from "./plugins-CXDOnert.js";
import { F as resolveAgentMainSessionKey, P as canonicalizeMainSessionAlias, d as loadSessionStore, g as updateSessionStore, m as saveSessionStore } from "./sandbox-BoauKXAW.js";
import { n as formatErrorMessage } from "./errors-B0eT3jVv.js";
import { o as resolveStorePath } from "./paths-Bkhd_qY8.js";
import { G as HEARTBEAT_TOKEN, t as deliverOutboundPayloads } from "./deliver-5rp6-FOH.js";
...
const CRON_EVENT_PROMPT = "A scheduled reminder has been triggered. The reminder message is shown in the system messages above. Please relay this reminder to the user in a helpful and friendly way.";
...
async function runHeartbeatOnce(opts) {
	...
	const ctx = {
		Body: appendCronStyleCurrentTimeLine(hasExecCompletion ? EXEC_EVENT_PROMPT : hasCronEvents ? CRON_EVENT_PROMPT : resolveHeartbeatPrompt(cfg, heartbeat), cfg, startedAt),
		From: sender,
		To: sender,

...
import { D as info, E as danger, I as colorize, L as isRich, M as setVerbose, R as theme, S as normalizeChatChannelId, c as defaultRuntime, h as DEFAULT_CHAT_CHANNEL, l as restoreTerminalState, r as enableConsoleCapture, s as visibleWidth, v as getChatChannelMeta } from "./subsystem-Bh1Y_6Uv.js";
import { C as shortenHomePath, E as toWhatsappJid, S as shortenHomeInString, b as resolveUserPath, h as normalizeE164, n as assertWebChannel, v as resolveHomeDir } from "./utils-es4ygvQ-.js";
import "./pi-embedded-helpers-yEQRtLyw.js";
import { Ct as formatControlUiSshHint, D as runMessageAction, Et as moveToTrash, Ft as waitForGatewayReachable, I as CHANNEL_MESSAGE_ACTION_NAMES, Mt as resolveControlUiLinks, Ot as openUrl, P as formatTargetDisplay, St as ensureWorkspaceAndSessions, Tt as handleReset, Wr as applyTemplate, an as registerMemoryCli, at as CHANNEL_TARGETS_DESCRIPTION, br as lookupContextTokens, ht as resolveCommitHash, jt as randomToken, kr as installUnhandledRejectionHandler, on as runMemoryStatus, ot as CHANNEL_TARGET_DESCRIPTION, sn as monitorWebChannel, t as getReplyFromConfig, un as waitForever, vt as DEFAULT_WORKSPACE, xt as detectBrowserOpenSupport, yt as applyWizardMetadata } from "./reply-P_lTBhho.js";
import { l as normalizeAgentId, n as DEFAULT_AGENT_ID, t as DEFAULT_ACCOUNT_ID } from "./session-key-BWxPj0z_.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-Cv_Ofd1m.js";
import { c as resolveDefaultAgentId, f as DEFAULT_AGENT_WORKSPACE_DIR, h as DEFAULT_IDENTITY_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, w as resolveDefaultAgentWorkspaceDir, x as ensureAgentWorkspace } from "./agent-scope-bNHJh30H.js";
import { Dt as DEFAULT_MODEL, Et as DEFAULT_CONTEXT_TOKENS, H as resolveEnvApiKey, Ot as DEFAULT_PROVIDER, St as normalizeSecretInput, at as resolveApiKeyForProfile, d as resolveConfiguredModelRef, et as resolveAuthProfileOrder, ht as ensureAuthProfileStore, mt as upsertAuthProfile, s as normalizeProviderId, vt as resolveAuthStorePath, xt as normalizeOptionalSecretInput } from "./model-selection-0Mb0IXS7.js";
...
import { r as normalizeEnv, t as isTruthyEnvValue } from "./env-BxRc6wWv.js";
import { M as VERSION, N as loadDotEnv, c as writeConfigFile, g as parseDurationMs, i as loadConfig, o as readConfigFileSnapshot, r as createConfigIO } from "./config-CqX-XS_G.js";
import "./manifest-registry-3It8Z8yN.js";
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-CXDOnert.js";
import { D as resolveSessionKey, E as deriveSessionKey, d as loadSessionStore, m as saveSessionStore } from "./sandbox-BoauKXAW.js";
import "./image-BYkg7G5v.js";
import "./pi-model-discovery-CV2V1HHz.js";
import { c as describePortOwner, l as ensurePortAvailable, s as PortInUseError, u as handlePortError } from "./chrome-Dm-EgOjJ.js";
...
import { h as GATEWAY_CLIENT_NAMES, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES } from "./message-channel-Cu61-7H6.js";
import "./logging-BzvBIA3Y.js";
import "./accounts-C2elk6PC.js";
import { a as resolveSessionTranscriptsDirForAgent, i as resolveSessionTranscriptsDir, o as resolveStorePath } from "./paths-Bkhd_qY8.js";
...
import { i as randomIdempotencyKey, n as callGateway } from "./call-p03PxzN2.js";
...
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-CjQRlDx4.js";
...
import { t as createDefaultDeps } from "./deps-Cd7OPXR6.js";
import { l as ensureBinary, u as promptYesNo } from "./tailscale-Cu-2HNvU.js";
import { t as isMainModule } from "./is-main-WWuz28Ip.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-BgLvMbz_.js";
import { a as gatewayInstallErrorHint, g as assertSupportedRuntime, i as buildGatewayInstallPlan, r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-C9zJCD-A.js";
import { a as buildAgentSummaries, c as loadAgentIdentity, f as parseIdentityMarkdown, i as applyAgentConfig, l as pruneAgentConfig, n as statusCommand, o as findAgentEntryIndex, s as listAgentEntries, t as runOnboardingWizard, u as identityHasValues } from "./onboarding-RzPoFpis.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-C89IG08W.js";
import { n as logConfigUpdated, t as formatConfigPath } from "./logging-MMRGFxGI.js";
import "./note-5WqioBRA.js";
import { t as WizardCancelledError } from "./prompts--d-6l5Ln.js";
import { t as createClackPrompter } from "./clack-prompter-BCiBkJVr.js";
import { _ as applyAuthChoice, a as CustomApiError, b as applyGoogleGeminiModelDefault, g as warnIfModelConfigLooksOff, l as resolveCustomProviderId, o as applyCustomApiConfig, s as parseNonInteractiveCustomApiFlags, v as applyOpenAIConfig, x as promptAuthChoiceGrouped, y as upsertSharedEnvVar } from "./onboard-skills-CglG-whW.js";
import { $ as setCloudflareAiGatewayConfig, C as applyLitellmConfig, E as applyMoonshotConfigCn, F as applyTogetherConfig, G as applyZaiConfig, L as applyVeniceConfig, N as applySyntheticConfig, Q as setAnthropicApiKey, T as applyMoonshotConfig, U as applyXiaomiConfig, V as applyXaiConfig, at as setOpencodeZenApiKey, bt as buildTokenProfileId, ct as setSyntheticApiKey, dt as setVercelAiGatewayApiKey, et as setGeminiApiKey, f as applyOpencodeZenConfig, ft as setXaiApiKey, g as applyMinimaxConfig, it as setMoonshotApiKey, j as applyQianfanConfig, k as applyOpenrouterConfig, lt as setTogetherApiKey, m as applyMinimaxApiConfig, mt as setZaiApiKey, nt as setLitellmApiKey, ot as setOpenrouterApiKey, pt as setXiaomiApiKey, rt as setMinimaxApiKey, st as setQianfanApiKey, tt as setKimiCodingApiKey, ut as setVeniceApiKey, v as applyAuthProfileConfig, x as applyKimiCodeConfig, xt as validateAnthropicSetupToken, y as applyCloudflareAiGatewayConfig, z as applyVercelAiGatewayConfig } from "./github-copilot-auth-DP14xwtF.js";
import { n as setupChannels } from "./onboard-channels-D0B-mLmg.js";
import "./plugin-auto-enable-CrONSZDi.js";
import "./archive-CXhvR9nU.js";
import "./skill-scanner-DrVEHfC6.js";
import "./installs-DYrEcixp.js";
import { l as healthCommand } from "./health-format-CBxH6AnE.js";
import "./update-runner-DSncprVF.js";
import "./auth-BvIPpm7G.js";
import "./audit-CeJ-MP-P.js";
import { t as renderTable } from "./table-DEnmtvl5.js";
import "./skills-status-BkAjWh29.js";
import { t as resolveGatewayService } from "./service-Cd4BxKuo.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-D6wTPnHi.js";
import "./service-audit-Ww0Whqby.js";
import "./node-service-CM5vkdIo.js";
import "./channels-status-issues-CIvi5Dko.js";
import { c as registerSubCliCommands, d as getPositiveIntFlagValue, f as getVerboseFlag, l as getCommandPath, m as hasHelpOrVersion, p as hasFlag, u as getFlagValue } from "./completion-cli-CM6wJ9-K.js";
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-JgOxK-Y3.js";
import { t as formatHelpExamples } from "./help-format-DAj7l5uV.js";
import { a as createOutboundSendDeps, n as resolveSessionKeyForRequest, t as agentCommand } from "./agent-DPcyrtBe.js";
import { i as hasExplicitOptions, n as resolveCliChannelOptions, r as ensurePluginRegistryLoaded } from "./channel-options-DtxQnTT9.js";
import { n as parsePositiveIntOrUndefined, t as collectOption } from "./helpers-CRzoyyXS.js";
import { i as CONFIGURE_WIZARD_SECTIONS, n as configureCommand, r as configureCommandWithSections } from "./configure-DTUNoixq.js";
import { n as ensureSystemdUserLingerNonInteractive } from "./systemd-linger-BxjTrgoH.js";
import "./widearea-dns-2ah0bkAj.js";
import "./auth-health-lcMI7abo.js";
import { n as loadAndMaybeMigrateDoctorConfig, t as doctorCommand } from "./doctor-BU_Zm_Bi.js";
import "./hooks-status-U2JQ8wza.js";
import "./tui-CDrsvPOo.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-DTUNoixq.js").then((n) => n.t);

...
import { I as colorize, L as isRich, R as theme, u as clearActiveProgressLine } from "./subsystem-Bh1Y_6Uv.js";
...
function formatLogTimestamp(value, mode = "plain", localTime = false) {
	...
	let timeString;
	if (localTime) {
		const tzoffset = parsed.getTimezoneOffset() * 6e4;
		timeString = new Date(parsed.getTime() - tzoffset).toISOString().slice(0, -1);

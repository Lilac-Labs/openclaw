...
import { b as resolveUserPath } from "./utils-es4ygvQ-.js";
import { n as DEFAULT_AGENT_ID } from "./session-key-BWxPj0z_.js";
import { a as resolveAgentModelPrimary } from "./agent-scope-bNHJh30H.js";
import { a as saveJsonFile, i as loadJsonFile, r as resolveCopilotApiToken, t as DEFAULT_COPILOT_API_BASE_URL } from "./github-copilot-token-BW-SEg7E.js";
...
//#endregion
export { auth_profiles_exports as $, TOGETHER_BASE_URL as A, resolveApiKeyForProvider as B, resolveImplicitBedrockProvider as C, resolveAuthProfileDisplayLabel as Ct, VENICE_DEFAULT_MODEL_REF as D, DEFAULT_MODEL as Dt, VENICE_BASE_URL as E, DEFAULT_CONTEXT_TOKENS as Et, SYNTHETIC_MODEL_CATALOG as F, getShellPathFromLoginShell as G, resolveEnvApiKey as H, buildSyntheticModelDefinition as I, shouldDeferShellEnvFallback as J, loadShellEnvFallback as K, getApiKeyForModel as L, buildTogetherModelDefinition as M, SYNTHETIC_BASE_URL as N, VENICE_MODEL_CATALOG as O, DEFAULT_PROVIDER as Ot, SYNTHETIC_DEFAULT_MODEL_REF as P, resolveCloudflareAiGatewayBaseUrl as Q, getCustomProviderApiKey as R, normalizeProviders as S, normalizeSecretInput as St, resolveImplicitProviders as T, CODEX_CLI_PROFILE_ID as Tt, resolveModelAuthMode as U, resolveAwsSdkEnvVarName as V, getShellEnvAppliedKeys as W, CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF as X, shouldEnableShellEnvFallback as Y, buildCloudflareAiGatewayModelDefinition as Z, QIANFAN_DEFAULT_MODEL_ID as _, updateAuthProfileStoreWithLock as _t, isCliProvider as a, resolveApiKeyForProfile as at, buildXiaomiProvider as b, resolveOpenClawAgentDir as bt, parseModelRef as c, generateChutesPkce as ct, resolveConfiguredModelRef as d, listProfilesForProvider as dt, resolveAuthProfileOrder as et, resolveDefaultModelForAgent as f, markAuthProfileGood as ft, QIANFAN_BASE_URL as g, loadAuthProfileStore as gt, resolveThinkingDefault as h, ensureAuthProfileStore as ht, getModelRefStatus as i, resolveProfileUnusableUntilForDisplay as it, TOGETHER_MODEL_CATALOG as j, buildVeniceModelDefinition as k, resolveAllowedModelRef as l, parseOAuthCallbackInput as lt, resolveModelRefFromString as m, upsertAuthProfile as mt, buildConfiguredAllowlistKeys as n, markAuthProfileFailure as nt, modelKey as o, CHUTES_AUTHORIZE_ENDPOINT as ot, resolveHooksGmailModel as p, setAuthProfileOrder as pt, resolveShellEnvFallbackTimeoutMs as q, buildModelAliasIndex as r, markAuthProfileUsed as rt, normalizeProviderId as s, exchangeChutesCodeForTokens as st, buildAllowedModelSet as t, isProfileInCooldown as tt, resolveAllowlistModelKey as u, repairOAuthProfileIdMismatch as ut, XIAOMI_DEFAULT_MODEL_ID as v, resolveAuthStorePath as vt, resolveImplicitCopilotProvider as w, CLAUDE_CLI_PROFILE_ID as wt, normalizeGoogleModelId as x, normalizeOptionalSecretInput as xt, buildQianfanProvider as y, resolveAuthStorePathForDisplay as yt, requireApiKey as z };
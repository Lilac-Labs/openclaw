import { W as resolveGatewayPort } from "./entry.js";
import { n as runExec } from "./exec-B8JKbXKW.js";
import { r as isLoopbackHost } from "./ws-C0k_dhCP.js";
import { A as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, D as DEFAULT_BROWSER_EVALUATE_ENABLED, E as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, O as DEFAULT_OPENCLAW_BROWSER_COLOR, S as stopChromeExtensionRelayServer, _ as appendCdpPath, a as resolveOpenClawUserDataDir, h as normalizeCdpWsUrl, i as launchOpenClawChrome, k as DEFAULT_OPENCLAW_BROWSER_ENABLED, n as isChromeCdpReady, o as stopOpenClawChrome, p as createTargetViaCdp, r as isChromeReachable, x as ensureChromeExtensionRelayServer, y as getHeadersWithAuth } from "./chrome-yIKmOzCO.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-x4NYs-1P.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-C43wv1ZF.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-C43wv1ZF.js")).closePlaywrightBrowserConnection();
		} catch {}

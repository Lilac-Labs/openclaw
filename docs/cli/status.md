...
- Update info surfaces in the Overview; if an update is available, status prints a hint to re-run the installer or use your package manager (see [Updating](/install/updating)).

...
<Card title="Bambu 3D Printer Control" icon="print" href="#">
...
<Card title="Vienna Transport (Wiener Linien)" icon="train" href="#">
...
<Card title="R2 Upload (Send Me My Files)" icon="cloud-arrow-up" href="#">
...
OpenClaw connected to Jira, then generated a new skill on the fly.
</Card>
...
<Card title="OpenRouter Transcription" icon="microphone" href="#">
  **@obviyus** • `transcription` `multilingual` `skill`

Multi-lingual audio transcription via OpenRouter (Gemini, etc).
</Card>
...
<Card title="CalDAV Calendar" icon="calendar" href="#">
